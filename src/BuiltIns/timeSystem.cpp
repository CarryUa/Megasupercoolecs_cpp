...
namespace
{
const high_resolution_clock::time_point PROGRAM_START_TIME_POINT =
    TIME_POINT_NOW();
}
...
{
  this->set_all_units_from_nanos(
      duration_cast<nanoseconds>(TIME_POINT_NOW() - PROGRAM_START_TIME_POINT)
          .count());
}
